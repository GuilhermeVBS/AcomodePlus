...
if (isset($_SESSION['mensagem'])) {
    ...
    $conteudo = $_SESSION['mensagem']['conteudo'];
    echo "<script>
        Swal.fire({
...
$todos = $imovelDAO->controlarImoveis();
...
<body>
    ...
    <body>
        ...
        <nav>
            ...
            <a href="contratoProprietario.php">Cadastrar Imóvel</a>
            <a href="imoveisRejeitados.php">Imóveis Reprovados</a>
            <a href="listarImoveis.php">Imoveis Cadastrados</a>
            <a href="listarUsuarios.php">Usuarios Cadastrados</a>
